      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {PROJECTS.map((project) => (
          <motion.div
            ...
            variants={fadeIn}
          >
            <Card className="h-full bg-background/10 border border-primary/20 backdrop-blur-sm hover:bg-card/10 hover:scale-105 hover:border-primary/50 hover:shadow-[0_0_15px_rgba(0,255,170,0.1)] transition-all duration-300 ease-in-out">
